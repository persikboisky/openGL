...
> Находит эти строки (они в начале), и указываем версию
...
принемает путь к png изображению, возращает строку этого изображения

png::width, png::height, png::channels;
хронят ширину, высоту, кол-во каналов в изображении
```
> [!NOTE]
> при загрузки нового изображения, все переменые структуры png будут перезаписана
